...
![1547105026929](./imgs/1547105026929.png)

PPT模板：

![1547103297864](./imgs/1547103297864.png)

![1547103359158](./imgs/1547103359158.png)
...
public:
	...
	MyArray(const MyArray& arr)
	{
		...
		// this->pAddress = arr.pAddress; // 编译器默认，浅拷贝
	...
	//重载[] 操作符  arr[0]
	T& operator [](int index)  // T& 可以返回做左值操作，例如：arr[0] = 111
	{
