###### datetime:2022/1/5 9:01
###### author:nzb

# GeeRPC第二天 支持并发与异步的客户端

本文是[7天用Go从零实现RPC框架GeeRPC](./geerpc.md)的第二篇。
...
[day2-client/client.go](../day2-client/client.go)
...
[day2-client/main/main.go](../day2-client/main/main.go)
