...
![image-20200718161111596](./imgs/image-20200718161111596.png)
...
- 强制的代码风格
  ...
  左括号必须紧接着语句不换行，这个特性刚开始会使开发者不习惯，但随着对Go语言的不断熟悉，就会发现风格统一让大家在阅读代码时把注意力集中在解决问题上，而不是代码风格上
