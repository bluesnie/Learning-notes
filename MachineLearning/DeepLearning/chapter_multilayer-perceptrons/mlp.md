...
我们在《线性回归》中描述了仿射变换，
它是一种带有偏置项的线性变换。
首先，回想一下如《softmax回归》中所示的softmax回归的模型架构。
...
![](../img/output_mlp_76f463_18_1.svg)
...
![](../img/output_mlp_76f463_33_1.svg)
...
![](../img/output_mlp_76f463_48_0.svg)
...
$$ 设 \mu =-x，则y_{\mu} = \frac{1}{1+e^{\mu}} , \\
求导：\frac{\mathrm{d} y}{\mathrm{d} \mu} =\frac{-e^{\mu}}{(1+e^{\mu})^{2}} (除法法则); \\
\frac{\mathrm{d} \mu}{\mathrm{d} x} = -1; \\
所以：\frac{\mathrm{d} y}{\mathrm{d} x} = \frac{\mathrm{d} y}{\mathrm{d} \mu}\frac{\mathrm{d} \mu}{\mathrm{d} x} \\
= \frac{-e^{\mu}}{(1+e^{\mu})^{2}}\cdot -1,\mu = -x带入得，\frac{e^{-x}}{(1+e^{-x})^{2}}  $$
...
![](../img/output_mlp_76f463_66_0.svg)
...
![](../img/output_mlp_76f463_81_0.svg)
...
$$ 设 \mu =-2x，则y_{\mu} = \frac{1-e^{\mu}}{1+e^{\mu}} , \\
求导：\frac{\mathrm{d} y}{\mathrm{d} \mu} = \frac{(1+e^{\mu })\cdot -e^{\mu} -(1-e^{\mu })\cdot e^{\mu}}{(1+e^{\mu})^{2}} \\
= \frac{-2e^{\mu}}{(1+e^{\mu})^{2}};  \\
\frac{\mathrm{d} \mu}{\mathrm{d} x} = -2; \\
则\frac{\mathrm{d} y}{\mathrm{d} x} = \frac{\mathrm{d} y}{\mathrm{d} \mu}\frac{\mathrm{d} \mu}{\mathrm{d} x} \\
= \frac{4e^{\mu}}{(1+e^{\mu})^{2}} = \frac{4e^{-2x}}{(1+e^{-2x})^{2}} = 1 - \tanh ^{2}(x) $$
...
![](../img/output_mlp_76f463_96_0.svg)
