...
《梯度下降》中使用完整数据集来计算梯度并更新参数，
《随机梯度下降》中一次处理一个训练样本来取得进展。
...
需要注意的是，在 《批量规范化》中，我们使用了一种在很大程度上取决于小批量中的方差的正则化。
随着后者增加，方差会减少，随之而来的是批量规范化带来的噪声注入的好处。
关于实例，请参阅 `Ioffe.2017`，了解有关如何重新缩放并计算适当项目。
...
《线性回归的从零开始实现》一节中已经实现过小批量随机梯度下降算法。
...
![](../img/output_minibatch-sgd_f4d60f_126_1.svg)
...
![](../img/output_minibatch-sgd_f4d60f_141_1.svg)
...
![](../img/output_minibatch-sgd_f4d60f_156_1.svg)
...
![](../img/output_minibatch-sgd_f4d60f_171_1.svg)
...
![](../img/output_minibatch-sgd_f4d60f_186_0.svg)
...
![](../img/output_minibatch-sgd_f4d60f_216_1.svg)
