...
![](../img/output_language-models-and-dataset_789d14_21_0.svg)
...
$$n_i \propto \frac{1}{i^\alpha},\space\space\space\space\space\text{8.3.7}$$
...
![](../img/output_language-models-and-dataset_789d14_66_0.svg)
...
（如前面章节中定义的`d2l.load_data_fashion_mnist`）类似地使用。
