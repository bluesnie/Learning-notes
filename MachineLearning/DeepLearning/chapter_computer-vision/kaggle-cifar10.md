...
图13.13.1 的左上角显示了数据集中飞机、汽车和鸟类的一些图像。

### 下载数据集

登录Kaggle后，我们可以点击图13.13.1 中显示的CIFAR-10图像分类竞赛网页上的“Data”选项卡，然后单击“Download All”按钮下载数据集。
...
我们定义了《残差网络（ResNet）》中描述的Resnet-18模型。
...
![](../img/output_kaggle-cifar10_42a34e_169_1.svg)
...
![](../img/output_kaggle-cifar10_42a34e_181_1.svg)

向Kaggle提交结果的方法与《实战Kaggle比赛：预测房价》中的方法类似，上面的代码将生成一个
