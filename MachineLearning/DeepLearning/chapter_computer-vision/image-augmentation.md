...
![](../img/output_image-augmentation_7d0887_18_0.svg)
...
![](../img/output_image-augmentation_7d0887_42_0.svg)
...
![](../img/output_image-augmentation_7d0887_54_0.svg)

在我们使用的示例图像中，猫位于图像的中间，但并非所有图像都是这样。
在《汇聚层》中，我们解释了汇聚层可以降低卷积层对目标位置的敏感性。
...
![](../img/output_image-augmentation_7d0887_66_0.svg)
...
![](../img/output_image-augmentation_7d0887_78_0.svg)
...
![](../img/output_image-augmentation_7d0887_90_0.svg)
...
![](../img/output_image-augmentation_7d0887_102_0.svg)
...
![](../img/output_image-augmentation_7d0887_114_0.svg)
...
![](../img/output_image-augmentation_7d0887_126_3.svg)
...
接下来，我们[**定义一个辅助函数，以便于读取图像和应用图像增广**]。PyTorch数据集提供的`transform`参数应用图像增广来转化图像。有关`DataLoader`的详细介绍，请参阅《图像分类数据集》。
...
![](../img/output_image-augmentation_7d0887_178_1.svg)
